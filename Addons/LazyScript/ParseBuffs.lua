...
function lazyScript.loadBuffTable()
	...
	lazyScript.buffTable = {
		...
		flourish             = lazyScript.Buff:New("flourish",            "Ability_DualWield"                               ),
		...
		berserk              = lazyScript.Buff:New("berserk",             "Ability_Druid_Berserk"                           ),
		...
		qf                   = lazyScript.Buff:New("qf",                  "btnholyscriptures"                               ),
		zf                   = lazyScript.Buff:New("zf",                  "Spell_Holy_UnyieldingFaith"                      ),
		afd                  = lazyScript.Buff:New("afd",                 "Ability_Racial_Avatar"                           ),
		...
		sjrh                 = lazyScript.Buff:New("sjrh",                "Spell_Nature_StormReach"                         ),
		...
		divIntr              = lazyScript.Buff:New("divIntr",             "Spell_Nature_TimeStop"                           ),
		...
		hof                  = lazyScript.Buff:New("hof",                 "Spell_Holy_SealOfValor"                          ),
		hop                  = lazyScript.Buff:New("hop",                 "Spell_Holy_SealOfProtection"                     ),
		hor                  = lazyScript.Buff:New("hor",                 "Spell_Holy_Redemption"                           ),
		hos                  = lazyScript.Buff:New("hos",                 "Spell_Holy_SealOfSacrifice"                      ),
		holyShield           = lazyScript.Buff:New("holyShield",          "Spell_Holy_BlessingOfProtection"                 ),
		holyMight            = lazyScript.Buff:New("holyMight",           "Spell_Holy_HolyNova"                             ),
		...
		kr                   = lazyScript.Buff:New("kr",                  "Spell_Holy_CrusaderStrike"                       ),

		-- Shaman related
		bloodlust            = lazyScript.Buff:New("bloodlust",           "Spell_Nature_BloodLust"                          ),
		earthShield          = lazyScript.Buff:New("earthShield",         "Spell_Nature_SkinofEarth"                        ),
		...
		fbdj                 = lazyScript.Buff:New("fbdj",                "Ability_Shaman_StormStrike"                      ),
		...
		kn                   = lazyScript.Buff:New("kn",                  "Spell_Shadow_UnholyFrenzy"                       ),
		...
		fsys                 = lazyScript.Buff:New("fsys",                "Spell_Holy_ElunesGrace"                          ),
